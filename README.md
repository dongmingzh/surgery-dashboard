...
打开 [GitHub Pages 看板](https://donoghzzz.github.io/surgery-dashboard/)，点击“导入 Excel / CSV”。页面自带完全合成的演示数据，可先体验筛选和图表联动。
...
仓库内演示数据均为合成数据，使用“患者001”“医生01”“DEMO001”等演示标识，不对应真实人员。
